...
\subsection{Team Meet}
Weekly Meetings will occur every Wednesday at 1:30 PM. These Meetings will either be in person or online, meetings are manditory in person if they occur within a week of a deliverable worth 10\% of the total course grade.


\subsection{Supervisor Meeting}
Meeting with our supervisor will occur once every BLANK weeks, they will be primarily online unless there aer instances where it is as convinient to meet in person as online.
\subsection{Meeting Structure}

\subsubsection{Roles}
Roles will be taken by the most relavent individual assigned to them for each meeting
\begin{itemize}
  \item \textbf{Chair (Mason/Michael)}: The meeting lead; takes charge of organizing the group and ensuring the meeting is on track to cover and complete the predesignated meeting topics.
  \item \textbf{Notery (Pedro/Jack)}: The note taker; makes records of each topic discussed in a meeting summarizing the issues covered and plans to address them. 
\end{itemize}

\subsubsection{Agenda Structure}

The Agenda will follow the below structure:
\\
\noindent\rule{\linewidth}{0.4pt}
\textbf{Purpose of Meeting}\\
\textit{Describe reason for meeting}\\
\\
\textbf{Date and Time}\\
\textit{XX:XX DD/MM/YYYY}\\
\\
\textbf{Attendance}\\
\Square Jack\\
\Square Mason\\
...
\Square Micheal\\
\\
\textbf{Items To Address}
\\
\textit{List items that are relevent to the meeting and the plan to tackle them}\\
\noindent\rule{\linewidth}{0.4pt}
