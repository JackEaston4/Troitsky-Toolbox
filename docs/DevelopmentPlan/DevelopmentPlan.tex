...
Due to nature of our toolbox providing a variety of services and features of variety levels of complexity,
not every tool is relevant to demonstrate in our Proof of Concept Demonstration.

Among the planned tools, uniquely tailored to the specific needs of the McMaster Troitsky team,
the most techincally complex tool will assist the team with visualization, performance estimation,
and rule compliance testing based on their designs.

Since the specifc details of rule compliance and performance estimation aren't specifically relevant for our POC Demo,
we plan to focus on extracting and visualizing data from the 3D models of a given bridge design.
For our POC demo, we plan to be able to load a step file (.stp -- universal 3D CAD file format) and desplay a visualization or
rendering of file's contents. Then we also want to extract numerical data from the .stp file related to the bridge,
which in our final deliverable will plug into our competition rule compliance assessment tool as well as our projected bridge performance and metrics tool.

This is the individually most complicated feature we plan to implement in the Troitsky Toolbox, so it serves as one of our greatest risks.
