...
We will be using the standard GitHub KanBan template to outline issues and create a roadmap of major project dates.
Here is a link to our \href{https://github.com/users/JackEaston4/projects/3/views/2}{KanBan}
