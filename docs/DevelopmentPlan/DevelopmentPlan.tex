...
The Team Communication Plan outlines what means of communication will be used for what purpose.
\subsection{GitHub}
GitHub will act as our main file sharing platform, both latex documents for submission like this development plan and the code used in the development of the Toolbox will be stored and edited through GitHub. 
Additionally, all work assignments will be outlined as issues on the KanBan board along with the Meeting Agendas, Peer Reviews, and Lecture Overviews.
\subsection{Teams}
Microsoft Teams will act as our online meeting platform and a secondary file sharing platform, for files too large to push to github or that would cause clutter inside of the GitHub.
\subsection{Text Message Group Chat}
The Text Message Group Chat will be used for simple updates/questions on how work is coming along, for example asking when a groupmember will be done reviewing an issue or for quick meeting reminders. 
